...
public class EnemyBehaviour : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider trig) 
    {
        ...
        {
            target = trig.gameObject; // The enemy will target the gameObject in the trigger area
    ...
    void RaycastDebugger()
    {
        ...
        {
            // Creates a ray that is visible for us to see in a certain colour
            Debug.DrawRay(rayCast.position, Vector2.left * rayCastLength, Color.magenta);
        }
